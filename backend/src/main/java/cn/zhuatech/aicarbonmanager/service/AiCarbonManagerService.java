...
import cn.zhuatech.aicarbonmanager.domain.DomainCatalog;
import cn.zhuatech.aicarbonmanager.model.*;
import cn.zhuatech.aicarbonmanager.repository.*;
 ...
 */
@Service
public class AiCarbonManagerService {
     ...
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
    public AiCarbonManagerService(BusinessRecordRepository records,AuditLogRepository audits,SystemSettingRepository settings,DomainCatalog catalog){
